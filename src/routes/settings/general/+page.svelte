	...
	const themes = [
		{
			value: "system",
			get label() {
				return i18n.t("settings.themeSystem");
			},
			icon: Monitor,
		},
		{
			value: "light",
			get label() {
				return i18n.t("settings.themeLight");
			},
			icon: Sun,
		},
		{
			value: "dark",
			get label() {
				return i18n.t("settings.themeDark");
			},
			icon: Moon,
		},
	] as const;
	...
	const languages = [
		{
			value: "auto",
			get label() {
				return i18n.t("settings.languageAuto");
			},
		},
		{
			value: "en",
			get label() {
				return i18n.t("settings.languageEnglish");
			},
		},
		{
			value: "ru",
			get label() {
				return i18n.t("settings.languageRussian");
			},
		},
		{
			value: "kk",
			get label() {
				return i18n.t("settings.languageKazakh");
			},
		},
	] as const;
...
<svelte:head>
	<title>{i18n.t("settings.generalTitle")}</title>
</svelte:head>
	...
	<div class="settings-section">
		<div class="section-row">
			<div>
				...
				<p class="description">
					{i18n.t("settings.appearanceDescription")}
				</p>
			</div>
			<select
				class="dropdown"
