...
<div class="dashboard-page">
	...
	<div class="dashboard-section">
		...
		<p class="description">
			{i18n.t("dashboard.systemHealth.description")}
		</p>

		<div class="stats-row">
			<div class="stat">
				<span class="label"
					>{i18n.t("dashboard.systemHealth.uptime")}</span
				>
				<span class="value uptime">{uptime}</span>
			</div>
			<div class="stat">
				<span class="label"
					>{i18n.t("dashboard.systemHealth.apiPing")}</span
				>
				<span class="value"
					>{stats.system.apiPing >= 0
						? `${stats.system.apiPing}ms`
						: i18n.t("dashboard.systemHealth.error")}</span
				>
			</div>
		</div>
	</div>
	...
	<div class="dashboard-section">
		...
		<div class="subsection">
			...
			<div class="stats-row">
				...
				<div class="stat">
					<span class="label"
						>{i18n.t("dashboard.users.thisWeek")}</span
					>
					<span class="value">{stats.users.newThisWeek}</span>
				</div>
				<div class="stat">
					<span class="label"
						>{i18n.t("dashboard.users.thisMonth")}</span
					>
	...
	<div class="dashboard-section">
		...
		<p class="description">
			{i18n.t("dashboard.conversations.description")}
		</p>

		<div class="stats-row">
			<div class="stat">
				<span class="label"
					>{i18n.t("dashboard.conversations.total")}</span
				>
				<span class="value">{stats.conversations.total}</span>
			</div>
			<div class="stat">
				<span class="label"
					>{i18n.t("dashboard.conversations.today")}</span
				>
				<span class="value">{stats.conversations.today}</span>
			</div>
			<div class="stat">
				<span class="label"
					>{i18n.t("dashboard.conversations.thisWeek")}</span
				>
